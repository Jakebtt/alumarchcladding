...
const textures = [
  ...
  { url: '/alumarchcladding/Midnight_Black.jpg', name: 'Obsidian', category: 'Solid Colors' },
  { url: '/alumarchcladding/Sandstone.jpg', name: 'Sandstone', category: 'Solid Colors' },
  { url: '/alumarchcladding/Slate_Grey.jpg', name: 'Twilight Grey', category: 'Solid Colors' },
  { url: '/alumarchcladding/Smoke.jpg', name: 'Graphite', category: 'Solid Colors' },
  { url: '/alumarchcladding/White.jpg', name: 'Pavilion White', category: 'Solid Colors' },
